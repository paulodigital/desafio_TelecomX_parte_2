...
**TelecomX_parte2.ipynb:** Notebook principal com todo o fluxo de análise e modelagem.

**dados_tratados.csv:** Base de dados limpa (gerada na Parte 1 do projeto).

## 🛠️ Preparação dos Dados
Para garantir que os modelos de aprendizado de máquina funcionassem corretamente, o processo de preparação seguiu as etapas abaixo relacionadas:
...
### 🚀 Base para a Execução do Projeto
Google Colab
